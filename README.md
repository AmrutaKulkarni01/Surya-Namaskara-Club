...
* The Home page
    ...
    -Below that user can read benefits of suryanamaskara and why one should join this particular group. This will motivate one to join the group.
    ...
    -In between a picture showing sequence of 12 asanas is displayed, which are performed as a part of one surynamaskara. 
...
![Screenshot of the landing page image with people on beach in sunset with the text "Become the best version of you!"](/assets/images/new_hero_img.jpg)
    -   The section below contains information on WHY the user should take this step and embark on a journey to unlock their full potential. In the text there is a link under the word Tools that brings the user to the services page when clicked.
